...
export declare function getSplashBackgroundColor(props: AndroidSplashConfig | null): string | null;
export declare function getSplashDarkBackgroundColor(props: AndroidSplashConfig | null): string | null;
